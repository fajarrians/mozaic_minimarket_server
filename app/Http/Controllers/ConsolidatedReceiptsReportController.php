...
class ConsolidatedReceiptsReportController extends Controller
{
    ...
    public function printConsolidatedReceiptsReport()
    {
        ...
        <table cellspacing=\"0\" cellpadding=\"2\" border=\"0\">
            <tr>
                <td><div style=\"text-align: center; font-size:14px; font-weight: bold\">LAPORAN PERDAGANGAN PENERIMAAN KAS</div></td>
            </tr>
            <tr>
        ...
        $filename = 'Laporan_Perdagangan_Penerimaan_kas_'.$start_date.'s.d.'.$end_date.'.pdf';
    ...
    public function exportConsolidatedReceiptsReport()
    {
        ...
        if(count($data_sales_invoice)>=0){
            ...
            $sheet->setCellValue('B1',"Laporan Perdagangan Penerimaan Kas Dari Periode ".date('d M Y', strtotime($start_date))." s.d. ".date('d M Y', strtotime($end_date)));	
            ...
            $filename='Laporan_Perdagangan_Penerimaan_Kas_'.$start_date.'_s.d._'.$end_date.'.xls';
