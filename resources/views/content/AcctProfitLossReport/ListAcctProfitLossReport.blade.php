            ...
            <table id="" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    @foreach ($income as $row)
                        <?php $income_amount += $APLR->getAmountAccount($row['account_id']) ?>
                        <tr>
                            <td style="width: 80%">&nbsp&nbsp&nbsp&nbsp&nbsp {{ $row['account_code'] }} - {{ $row['account_name'] }}</td>
                            <td style="width: 20%; text-align: right">{{ number_format($APLR->getAmountAccount($row['account_id']),2,'.',',') }}</td>
                        </tr>
                    @endforeach
                    <tr>
                    ...
                    @foreach ($expenditure as $row)
                        <?php $expenditure_amount += $APLR->getAmountAccount($row['account_id']) ?>
                        <tr>
                            <td style="width: 80%">&nbsp&nbsp&nbsp&nbsp&nbsp {{ $row['account_code'] }} - {{ $row['account_name'] }}</td>
                            <td style="width: 20%; text-align: right">{{ number_format($APLR->getAmountAccount($row['account_id']),2,'.',',') }}</td>
                        </tr>   
