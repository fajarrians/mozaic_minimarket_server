...
<div class="card border border-dark">
    ...
    <form method="post" action="{{ route('process-add-purchase-payment') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <br/>
            <div class="row">
                <p class="form-section"><b>Data Bank Supplier</b></p>
            </div>
            <br/>
            <div class="row form-group">
                <div class="col-md-6">
                ...
                <table class="table table-bordered table-advance table-hover">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th style='text-align:center'>Jumlah Sisa Hutang</th>
                            ...
                            if(count($purchaseinvoiceowing) == 0){
                                ...
                                foreach ($purchaseinvoiceowing AS $key => $val){?>
                                    <tr>
                                        ...
                                        <td style='text-align  : center'>{{number_format($val['owing_amount'] - $val['return_amount'], 2)}}</td>
                                        ...
                                        <td style='text-align  : center'>
                                            <input class="form-control input-bb" type="text" style='text-align:right' name="{{$no}}_last_balance_view" id="{{$no}}_last_balance_view" value="{{number_format($val['owing_amount'] - $val['return_amount'],2)}}" readonly/>
                                            <input class="form-control input-bb" type="hidden" style='text-align:right' name="{{$no}}_last_balance" id="{{$no}}_last_balance" value="{{$val['owing_amount'] - $val['return_amount']}}" readonly/>
                                            ...
                                            <input class="form-control input-bb" type="hidden" style='text-align:right' name="{{$no}}_owing_amount" id="{{$no}}_owing_amount" value="{{$val['owing_amount'] - $val['return_amount']}}" readonly/>
                                        </td>
                                    </tr>
                                <?php
                                $no++;
