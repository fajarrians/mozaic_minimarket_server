    ...
    <div class="card-body">
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::select('customer_id', $customers,  0, ['class' => 'form-control selection-search-clear select-form', 'id' => 'customer_id', 'name' => 'customer_id']) !!}
                </div>
            </div>
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a  type="submit" name="Save" class="btn btn-success" title="Save" onclick="processAddArraySalesInvoice()"> Tambah</a>
            </div>
        </div>
    </div>
    </div>
